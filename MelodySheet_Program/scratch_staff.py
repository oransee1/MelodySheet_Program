...
for sys_idx, (sy0, sy1) in enumerate(systems):
    ...
    w = sys_img.shape[1]
    # Staff lines usually span a large portion of the width
    # In a typical piano score, a staff line is about 70-80% of the page width
    # But because of white spaces (notes, etc.), we can use a lower threshold, say 30% of width
    staff_line_rows = np.where(row_sum > w * 0.30)[0]
    ...
    print(f"          Staff    y0={true_y0}, y1={true_y1} (h={true_y1-true_y0})")
