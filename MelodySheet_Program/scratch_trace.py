...
for a, b in regions:
    if b - a > max_sys_h:
        ...
        if len(staves) >= 2 and len(staves) % 2 == 0:
            ...
            print(f"  N={N}, num_splits={num_splits}, local_gaps={local_gaps}")
            if num_splits > 0:
